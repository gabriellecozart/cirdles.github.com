...
<br>
2. Upon clicking "Open," you will be brought to a screen asking for the title of the an <a href="/assets/images/Aliquot.png" target="_blank">aliquot</a> and you also have the ability to save aliquots.
<br>
...
<br>
3. You can arrive at the <a href="/assets/images/ReportSettings.png" target="_blank">fraction table</a> by either entering an aliquot or from your history page. The table of data that you mean to extract will be located here.
<br>
...
<br>-->
5. The <a href="/assets/images/Profile.png" target="_blank">credentials page</a> displays the entry fields of username and password. Once you have entered that information, you will receive two messages.
